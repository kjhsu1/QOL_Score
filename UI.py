...
# Set retro font
retro_font = tkFont.Font(family="Press Start 2P", size=10)  # Load the font using Tkinter
...
submit_button_image = tk.PhotoImage(file="/Users/kentahsu/Code/Personal/QOL_Score/boyyaky_button.png")  # Replace with your button image path
